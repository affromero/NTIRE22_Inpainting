import numpy as np
from utils.mask_generation.lama_generation.gen_mask_lama import get_model_from_config, forward_model
import cv2
import random

strokes_configs = [
    'utils/mask_generation/lama_generation/random_medium_256.yaml',
    'utils/mask_generation/lama_generation/random_thick_256.yaml',
    'utils/mask_generation/lama_generation/random_thin_256.yaml',
    'utils/mask_generation/lama_generation/random_medium_512.yaml',
    'utils/mask_generation/lama_generation/random_thick_512.yaml',
    'utils/mask_generation/lama_generation/random_thin_512.yaml',
]
    ...
    def __init__(self):
        ...
        for shape in stroke_shapes:
            ...
            for size in stroke_sizes:
                config = f'utils/mask_generation/lama_generation/random_{shape}_{size}.yaml'
