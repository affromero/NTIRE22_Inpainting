...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--upsampler', action='store_true', help='whether use samples to train the upsampler')
        parser.add_argument('--sample_path', type=str, default='./samples', help='paths that store samples, should contain subdir named after dataset_name')
